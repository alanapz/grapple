...
public final class EntityFieldBuilder {
    ...
    public static <X, T> EntityJoin<X, T> attributeJoin(@NotNull SingularAttribute<X, T> attribute) {
        return attributeJoin(attribute, null);
    }

    public static <X, T> EntityJoin<X, T> attributeJoin(@NotNull SingularAttribute<X, T> attribute, Consumer<AttributeFieldBuilder<X, T>> joinBuilder) {
